...
**Estudiante:** Jeronimo Cardu

**Despliegue:** [Render](https://entregable-n2-jeronimo-cardu.onrender.com/)

---

## Descripción

Este proyecto tiene como finalidad demostrar el uso de **Express**, **Handlebars** y **Socket.io** para la gestión de productos en tiempo real.  
Incluye funcionalidades para **crear**, **listar** y **eliminar productos**, además de la **subida de imágenes** mediante **Multer**.
...
npm install
```
2. Ejecutar el servidor de forma local:
